...
OUT = PROJECT / 'teensy-41-can-lin-r7-teensy-footprint-corrected.kicad_pcb'
...
def make_teensy_verified(ref='U1'):
    ...
    # Top edge left->right: GND,VIN,23..13,GND,41..33 (PJRC Teensy 4.1 side-row asymmetry).
    top = [('GND_T1','GND'),('VIN','+5V_REGULATED'),('23','CAN_A_RX'),('22','CAN_A_TX'),('21',None),('20',None),('19',None),('18',None),('17',None),('16',None),('15',None),('14',None),('13',None),('GND_T2','GND'),('41',None),('40',None),('39',None),('38',None),('37',None),('36',None),('35',None),('34',None),('33',None)]
...
txt('R7 OBD PIGTAIL + DIP SWITCH CAN/LIN INTERFACE',35,4,1.0,pcbnew.F_SilkS)
...
for ext in ['.kicad_pro','.kicad_prl']:
    ...
    dst=PROJECT/f'teensy-41-can-lin-r7-teensy-footprint-corrected{ext}'
